...
Gem::Specification.new do |spec|
  spec.name          = "ld4l-generic_work_rdf"
  spec.version       = LD4L::GenericWorkRDF::VERSION
  spec.authors       = ["E. Lynette Rayle"]
  spec.email         = ["elr37@cornell.edu"]
  spec.platform      = Gem::Platform::RUBY
  spec.summary       = %q{Several RDF models for bibliographic works.}
  spec.description   = %q{LD4L Generic Work RDF provides tools for modeling a bibliographic works as triples based on multiple ontologies and persisting to a triplestore.}
  spec.homepage      = "https://github.com/ld4l/generic_work_rdf"

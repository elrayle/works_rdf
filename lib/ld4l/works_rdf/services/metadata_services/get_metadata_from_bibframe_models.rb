  ...
  module WorksRDF
    class GetMetadataFromBibframeModels
      ...
      def self.call( models )
        ...
        metadata.title            = instance.title.first.label.first       if instance.title.first.label
        metadata.title            = instance.title.first.title_value.first if instance.title.first.title_value
        metadata.subtitle         = instance.title.first.subtitle.first    if instance.title.first.subtitle
